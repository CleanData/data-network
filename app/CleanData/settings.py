...
SECRET_KEY = 'el+owy29^0r31*@_j@$(3r-1_it16-m)0+o_8psy0^zx88w20r'
...
INSTALLED_APPS = (
    ...
    'CleanData.data_connections',			# note that you need to add the directory for the app to find it.
    #'django_dag', - I think this needs 1.4
    #'mptt',
)
